...
const FilePreviewCard: React.FC<{
  ...
  return (
    <div
      className={cn(
        "relative group bg-zinc-800 border w-fit border-zinc-700 rounded-lg p-3 size-[125px] shadow-md flex-shrink-0 overflow-hidden",
        isImage ? "p-0" : "p-3"
      )}
    >
      <div className="flex items-start gap-3 size-[125px] overflow-hidden">
        {isImage && file.preview ? (
          <div className="relative size-full rounded-md overflow-hidden bg-zinc-700">
            <img
        ...
        {!isImage && (
          <div className="flex-1 min-w-0 overflow-hidden">
            <div className="flex items-center gap-1.5 mb-1">
              <div className="group absolute flex justify-start items-end p-2 inset-0 bg-gradient-to-b to-[#1e1e1d] from-transparent overflow-hidden">
                <p className="absolute bottom-2 left-2 capitalize text-white text-xs bg-zinc-900 border border-zinc-800 px-2 py-1 rounded-md">
      ...
      <Button
        size="icon"
        variant="outline"
        className="absolute top-1 right-1 h-6 w-6 p-0 opacity-0 group-hover:opacity-100 bg-zinc-900 border-zinc-700 text-zinc-300"
...
const PastedContentCard: React.FC<{
  ...
  return (
    <div className="bg-zinc-800 border border-zinc-700 relative rounded-lg p-3 size-[125px] shadow-md flex-shrink-0 overflow-hidden">
      ...
      <div className="group absolute flex justify-start items-end p-2 inset-0 bg-gradient-to-b to-[#1e1e1d] from-transparent overflow-hidden">
        <p className="capitalize text-white text-xs bg-zinc-900 border border-zinc-800 px-2 py-1 rounded-md">
          PASTED
        </p>
        <div className="group-hover:opacity-100 opacity-0 transition-opacity duration-300 flex items-center gap-0.5 absolute top-2 right-2">
          <Button
            size="icon"
            variant="outline"
            className="size-6 bg-zinc-900 border-zinc-700 text-zinc-300"
...
export const ClaudeChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    ...
    >
      {isDragging && (
        <div className="absolute inset-0 z-50 bg-[#1C3F62]/60 border-2 border-dashed border-amber-500 rounded-xl flex flex-col items-center justify-center pointer-events-none">
      ...
      <div className="bg-[#1e1e1d] border border-zinc-800 rounded-xl shadow-xl items-end gap-2 min-h-[140px] flex flex-col focus-within:border-zinc-700 transition-colors">
        <textarea
          ref={textareaRef}
          value={message}
          ...
          disabled={disabled}
          className="flex-1 min-h-[90px] w-full p-4 focus:outline-none max-h-[220px] resize-none border-0 bg-transparent text-zinc-100 shadow-none placeholder:text-zinc-500 text-sm sm:text-base custom-scrollbar"
          rows={1}
        />
        <div className="flex items-center gap-2 justify-between w-full px-3 pb-2.5">
          <div className="flex items-center gap-2">
            <Button
              size="icon"
              variant="ghost"
              className="h-9 w-9 p-0 text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 flex-shrink-0"
        ...
        {(files.length > 0 || pastedContent.length > 0) && (
          <div className="overflow-x-auto border-t-[1px] p-3 border-zinc-800 w-full bg-[#161615] rounded-b-xl hide-scroll-bar">
...
export const Component: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#161615] flex items-center justify-center p-4">
